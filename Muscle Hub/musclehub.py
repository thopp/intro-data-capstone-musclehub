...
plt.title(Percent of total visitors)
...
app_pivot['Total']=app_pivot['Application'].add(app_pivot['No Application'])
print(app_pivot)
...
member_pivot['Total'] = member_pivot['Member'].add(member_pivot['Not Member'])
...
all_visitors_count = df.groupby(['ab_test_group', 'is_member']).first_name.count().reset_index()

final_member_pivot = all_visitors_count.pivot(columns = 'is_member',
                            index = 'ab_test_group',
                            values = 'first_name').reset_index()

final_member_pivot['Total'] = final_member_pivot['Member'].add(final_member_pivot['Not Member'])
